        ...
        return try await withCheckedThrowingContinuation { continuation in
            queue.async { [weak self] in
                ...
                do {
                    ...
                    // Xcode 16's iOS 18 SDK predates `.allowBluetoothHFP`.
                    // `.allowBluetooth` provides the equivalent hands-free input
                    // behavior while keeping the unsigned SideStore build portable.
